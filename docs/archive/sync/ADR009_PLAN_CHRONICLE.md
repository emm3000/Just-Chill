> Archived 2026-08-16.
> The live plan at `docs/sync/ADR009_PLAN.md` now carries only remaining work.
> This file preserves the full unit-by-unit chronicle of Phases 0-3, kept for the reasoning.
