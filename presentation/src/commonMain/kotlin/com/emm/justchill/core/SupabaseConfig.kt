 ...
 * (SUPABASE_URL / SUPABASE_ANON_KEY); iOS from the generated IosSupabaseConfig. Injected into the
 * commonMain supabaseModule so the createSupabaseClient builder stays platform-agnostic. The
