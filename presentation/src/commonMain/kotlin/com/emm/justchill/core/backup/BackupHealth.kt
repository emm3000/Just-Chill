...
/**
 * @property isDestinationDisclosed false blocks every upload to this account until the user
 *   acknowledges the disclosure (ADR 009 Decision 5), so a UI must not read it as a mere hint.
 */
