 ...
 * (SUPABASE_URL / SUPABASE_ANON_KEY). Injected into supabaseModule because :presentation cannot
 * reach :androidApp's generated BuildConfig — the dependency graph runs the other way. The
 * empty-URL -> "http://localhost:54321" fallback is applied
