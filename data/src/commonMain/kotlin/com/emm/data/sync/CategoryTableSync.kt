...
open class CategoryTableSync(private val db: EmmDatabaseData, client: SupabaseClient, logger: DiagnosticsLogger) :
    ...
    override fun localRevision(pk: String): LocalRevision? = db.categoriesQueries
        .categorySyncRevision(pk)
        .executeAsOneOrNull()
