...
class ReportMappersTest {
    ...
    @Test
    fun `uncategorized bucket gets the Sin categoria label and the neutral tint`() {
        ...
        assertEquals(emmDarkColors.catGraphite, share.tint)
    }

    @Test
    fun `a real category keeps its own name and color`() {
        ...
        assertEquals(emmDarkColors.catSage, share.tint)
    }
