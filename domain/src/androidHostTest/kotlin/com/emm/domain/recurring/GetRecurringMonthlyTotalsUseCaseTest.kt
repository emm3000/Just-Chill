...
class GetRecurringMonthlyTotalsUseCaseTest {
    ...
    fun `R4_5 only active templates contribute to totals`() {
        val list = listOf(
            detail("i1", TransactionType.Income, Money(30_000L)),
            detail("i2", TransactionType.Income, Money(10_000L), isActive = false),
            detail("sv1", TransactionType.Spend, amount = null),
            detail("s2", TransactionType.Spend, Money(20_000L), isActive = false),
        )
    ...
    fun `R4_6 multiple active income templates summed correctly`() {
        val list = listOf(
            detail("i1", TransactionType.Income, Money(100_000L)),
            detail("i2", TransactionType.Income, Money(50_050L)),
            detail("i3", TransactionType.Income, Money(25_025L)),
        )
    ...
    fun `R9_3 paused variable templates are not counted in activeVariableCount`() {
        val list = listOf(
            detail("av1", TransactionType.Income, amount = null),
            detail("pv1", TransactionType.Spend, amount = null, isActive = false),
            detail("pv2", TransactionType.Spend, amount = null, isActive = false),
            detail("pv3", TransactionType.Income, amount = null, isActive = false),
        )
