...
- The amount digits are irreducible. Every entry point shortens the path to the amount pad; no field, chip row or sheet gets added to `AddTransactionScreen`.
