...
- The pad is portrait-only (ADR 020): the manifest locks `MainActivity` upright and out of multi-window, and `AddTransactionScreenContent` picks `StackedTall` or `StackedShort` by height alone.
