...
// Drops any keystroke percentTextToBps would silently discard, so the field never displays text it
// does not parse: digits past PERCENT_DECIMALS and every decimal separator past the first.
