...
fun decodeBackupPayload(json: String): DecodedBackup {
...
// whole answer a verification needs: it walks back to an older pair instead of reporting why this one lost.
@Suppress("SwallowedException")
fun decodeBackupPayloadOrNull(json: String): DecodedBackup? = try {
