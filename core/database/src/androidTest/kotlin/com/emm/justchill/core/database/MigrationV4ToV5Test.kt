...
class MigrationV4ToV5Test {
    ...
    private lateinit var database: JustChillDatabase
    ...
    fun setUp() {
        ...
        database = JustChillDatabase(driver)
    ...
    fun the_composite_key_is_really_enforced_after_the_migration() {
        ...
        // too, as a plain SQLiteException nothing in :core:database catches.
    ...
    private fun migrate() =
        JustChillDatabase.Schema.migrate(driver, oldVersion = 4, newVersion = JustChillDatabase.Schema.version)
