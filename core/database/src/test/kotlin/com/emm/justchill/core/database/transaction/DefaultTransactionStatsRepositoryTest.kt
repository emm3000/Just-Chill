...
class DefaultTransactionStatsRepositoryTest {
    ...
    @Test
    fun `returns every live occurrence in the window with its amount and hour`() = runTest {
        insert(id = "t-1", categoryId = "cat-1", amount = 1000L, occurredAt = "2026-08-10T09:00:00")
        insert(id = "t-2", categoryId = "cat-2", amount = 2000L, occurredAt = "2026-08-11T21:00:00")
