...
class DefaultBackupRepository(private val db: JustChillDatabase, private val clock: Clock) : BackupRepository {
...
private fun JustChillDatabase.holdsLiveLoan(loanId: String): Boolean =
    loansQueries.byId(loanId).executeAsOneOrNull() != null

private fun JustChillDatabase.usableCategoryId(categoryId: String?, type: String): String? {
...
private fun JustChillDatabase.snapshot(exportedAt: Long, appVersion: String): ExportPayloadDto {
