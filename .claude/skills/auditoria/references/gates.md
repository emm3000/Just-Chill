...
| Sync | `core/database/CLAUDE.md` `## Backup`, `presentation/CLAUDE.md` `## Backup` and `docs/adr/009-backup-is-a-snapshot-not-row-replication.md` BEFORE any source file | 20 |
